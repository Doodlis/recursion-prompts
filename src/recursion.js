...
var sum = function(array) {
    ...
    var firstElement = clone.shift();
    return  firstElement + sum(clone);
};
...
var arraySum = function(array) {
    ...
    var flatArray = array.flat(2);
    var firstElement = flatArray.shift();
    return  firstElement + arraySum(flatArray);
...
var rMap = function(array, callback) {
    ...
    if (index <= array.length - 1) {
        ...
        return   [result, ...rMap(array.slice(index+1), callback)];
    }
};
...
var capitalizeFirst = function(array) {
    ...
    var firstLetter = firstElement.charAt(0).toUpperCase();
    return [firstLetter + firstElement.slice(1), ...capitalizeFirst(array)];
};
